...
# https://rdrr.io/cran/WGCNA/man/verboseBarplot.html
# Authors: Steve Horvath, with contributions from Zhijin (Jean) Wu and Peter Langfelder
# copied here to avoid installing entire WGCNA package to use local
# script
